      ...
      <View style={styles.container}>
        ...
        <View style={styles.row}>
          <TouchableOpacity onPress={ this.sevenPush.bind(this) }>
            <Text style={this.state.oneSelected ? styles.selected: styles.button}>7</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={ this.eightPush.bind(this) }>
            <Text style={this.state.twoSelected ? styles.selected: styles.button}>8</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={ this.ninePush.bind(this) }>
            <Text style={this.state.threeSelected ? styles.selected: styles.button}>9</Text>
          </TouchableOpacity>
        </View>
        <View style={styles.row}>
